...
<body style="margin:0; padding:0; background-color:#fff;">
  <center>
    <table bgcolor="#fff" width="95%" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
          <td align="center" valign="top">
            <strong>Muchas gracias por tu suscripción!</strong> <br>
            <p>
                En breve recibirás todas nuestras novedades :)
            </p>

            <p>
                Si tenés más consultas podes escribirnos al: <a style="color: grey;" href="mailto:info@superfil.com.ar">info@superfil.com.ar</a>
            </p>
