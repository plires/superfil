...
<body style="margin:0; padding:0; background-color:#fff;">
  <center>
    <table bgcolor="#fff" width="95%" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
          <td align="center" valign="top" style="font-size:25px; line-height:10px;"><strong>Superfil - '.$post['origin'].'</strong></td>
      </tr>
      <tr>
      ...
      <tr>
          <td align="center" valign="top"><p><strong>Ciudad: </strong>'.$post['city'].'</p></td>
      </tr>
