<header class="show">
	...
	<a href="./">
		<img class="logo" src="img/header/logo-superfil.png" alt="logo superfil">
	</a>
	...
	<section class="navigation_container" id="menu">
		...
		<nav>
			...
			<ul id="navigation">
				...
				<li><a class="trasition" id="btn_empresa" href="empresa">Empresa</a></li>
				<li><button class="trasition" id="btn_products">Productos</button></li>
				<li><a class="trasition" id="btn_contacto" href="contacto">Contacto</a></li>
				<li class="rrss">
