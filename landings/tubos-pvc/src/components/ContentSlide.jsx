        ...
        <div className='container'>
          <div className='row'>
            ...
            <div data-aos='fade-up' className={`col-md-7 ${styles.data}`}>
              ...
              <p>
                Estos tubos de PVC son altamente recomendados para grandes obras
                de infraestructura ya que poseen un gran diámetro y resistencia.
                El siguiente cuadro indica los diámetros disponibles aunque
                puede consultar por diámetros intermedios.
              </p>
            </div>
          </div>
        </div>
