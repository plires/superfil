...
///Casillas con datos
//////////////////////////////////////////////////////////////////////
define('BETIANA', array(
    'betiana@superfil.com.ar', 
    'Betiana', 
    'https://api.whatsapp.com/send/?phone=5491157972255&text=Hola%20Betiana!%20Necesito%20hacer%20una%20consulta!&app_absent=0', 
    '11-5797-2255'
));
...
define('EMAIL_VENTAS_JUNTAS', array( BETIANA ));
define('EMAIL_VENTAS_PALLETS', array( BETIANA ));
define('EMAIL_VENTAS_TUBOS', array( BETIANA ));
