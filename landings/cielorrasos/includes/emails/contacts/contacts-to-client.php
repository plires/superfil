    ...
    <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="600"
      ...
      <tr>
        <td style="vertical-align: middle;">
          ...
          <img src="{base}img-emails/header-email-cielorrasos.jpg"
      ...
      <!-- Texto-->
      <tr style="background-color: #002F63;">
      ...
      <!-- Boton : BEGIN -->
      <tr style="background-color: #002F63;">
        <td style="background-color: #002F63; text-align: center; padding: 40px;">
            ...
            <tr>
              <td class="button-td button-td-primary" style="border-radius: 4px; background: #FFFFFF;">
                <a class="fallback-font button-a button-a-primary" target="_blank" rel="noopener"
                  ...
                  style="background: #FFFFFF; border: 1px solid #FFFFFF; font-family: 'Montserrat', sans-serif; font-size: 18px; line-height: 28px; font-weight: 700; text-decoration: none; padding: 10px 20px; color: #002F63; display: block; border-radius: 4px;">RESPONDER
                </a>
              </td>
            </tr>
          </table>
